		...
		<footer class="primary text-center">
			<div class="row">
				<div class="col-md-4">
					<h3>PILKASIS</h3>
					<p>
						Proyek Siswa © 2017 <a href="http://blog.muhidin.web.id" target="_blank">SkillPro Programming</a>. Kelas X dan XI. Tema Asli <a href="http://tangituru.com" target="_blank">CREATIVEFULL</a>.
					</p>
				</div>
				<div class="col-md-4">
					<h3>TEMUKAN KAMI</h3>
