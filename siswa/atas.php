            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  ...
                  <img class="img-xs rounded-circle " src="../gambar/siswa/<?php echo $_SESSION['fotoskasis']; ?>" alt="<?php echo $_SESSION['userskasis']; ?>">
                  <span class="count bg-success"></span>
                </div>
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal"><?php echo $_SESSION['namaskasis']; ?></h5>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    ...
                    <p class="mb-0 d-none d-sm-block navbar-profile-name"><?php echo $_SESSION['namaskasis']; ?></p>
